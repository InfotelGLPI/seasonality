...
define('PLUGIN_SEASONALITY_VERSION', '1.6.0');
...
function plugin_init_seasonality() {
   ...
   if (Session::getLoginUserID()) {
      ...
      $PLUGIN_HOOKS['add_javascript']['seasonality'] = ["/public/lib/daterangepicker/jquery.comiseo.daterangepicker.min.js",
...
function plugin_version_seasonality() {
   ...
   return [
      ...
      'license'        => 'GPLv2+',
      'author'         => "<a href='http://blogglpi.infotel.com'>Infotel</a> & Ludovic Dupont",
